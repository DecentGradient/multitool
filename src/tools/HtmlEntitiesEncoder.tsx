...
const HtmlEntitiesEncoderComponent: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold">HTML Entities Encoder & Decoder</h2>
...
export const HtmlEntitiesEncoderModule: MultitoolModule = {
  id: 'html-entities',
  name: 'HTML Entities',
  category: 'Encoders',
  ...
  icon: FileCode2,
  render: HtmlEntitiesEncoderComponent,
};